	...
	static	String milkProducts[] = {"Butter" , "Cheese" , "Yogurt" , "IceCream" , "Whipped Cream" , "Heta" , "Ghee" , "Soft Cheese" , "Custard" , "Kefir" , "SourCream" , "Roquefort" , "Camembert" , "Swiss Cheese" , "Brie"};
		public static void main(String[] dMart){
			System.out.println("Main Started");
				System.out.println("Groceries items started");
				for(String grocery : groceries){
				System.out.println(grocery);
				}
					System.out.println("Vegitables items started");
					for(String vegitable : vegitables){
						System.out.println(vegitable);
					}
						System.out.println("Snakes items started");
						for(String snack : snacks){
							System.out.println(snack);
						}
							System.out.println("Fruits items started");
							for(String fruit : fruits){
							System.out.println(fruit);
						}
							System.out.println("Cosmetics items started");
							for(String cosmetic : cosmetics){
							System.out.println(cosmetic);
						}
							System.out.println("Chocolates items started");
							for(String chocolate : chocolates){
							System.out.println(chocolate);
						}
							System.out.println("Icecreams items started");
							for(String icecream : icecreams){
							System.out.println(icecream);
						}
							System.out.println("Biscuits items started");
							for(String biscuit : biscuits){
							System.out.println(biscuit);
						}
							System.out.println("Perfumes item started");
							for(String perfume : perfumes){
							System.out.println(perfume);
						}
							System.out.println("CoolDrinkes ietms started");
							for(String coolDrink : coolDrinks){
							System.out.println(coolDrink);
						}
							System.out.println("Alcohol items started");
							for(String alcohol : alcohols){
							System.out.println(alcohol);
						}
							System.out.println("HomeApplianvce items started");
							for(String homeAppliance : homeAppliances){
							System.out.println(homeAppliance);
						}
							System.out.println("MilkProducts items started");
