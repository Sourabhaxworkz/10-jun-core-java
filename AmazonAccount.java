class AmazonAccount{
	...
	public static boolean createAmazonAccount(String givenName , String surName , String contactAddress , String payMethod , long phoneNumber , String pwd){
		...
		isAccountCreated = validatingAmazonAccountUserDetails(givenName , surName , contactAddress , payMethod , phoneNumber , pwd);
	return isAccountCreated;
	}
	
	public static boolean validatingAmazonAccountUserDetails(String givenName , String surName , String contactAddress , String payMethod , long phoneNumber , String pwd){
